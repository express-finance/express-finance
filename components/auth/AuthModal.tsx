...
export const AuthModal = ({show, onClose}: AuthModalProps) => {
                ...
                <div className="px-4 sm:px-12">
                    ...
                    <Link href="/">
                      <a className="flex items-center space-x-1">
                        ...
                        <span className="text-xl font-semibold tracking-wide">
                          Express<span className="text-rose-500">Finance</span>
                        </span>
                      </a>
                    </Link>
                  </div>
                  ...
                  {!showSignIn ? (
                    <Dialog.Description className="mt-2 text-gray-500 text-base text-center">
                      Please create an account to begin using Express Finance.
                    </Dialog.Description>
                  ) : null}
